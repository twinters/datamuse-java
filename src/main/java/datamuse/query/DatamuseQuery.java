package datamuse.query;

import java.util.Collection;

import com.google.common.collect.ImmutableList;

import datamuse.constraints.AntonymConstraint;
import datamuse.constraints.ApproximateRhymeConstraint;
import datamuse.constraints.ComprisesConstraint;
import datamuse.constraints.ConsonantMatchConstraint;
import datamuse.constraints.FrequentlyAfterConstraint;
import datamuse.constraints.FrequentlyBeforeConstraint;
import datamuse.constraints.HomophoneConstraint;
import datamuse.constraints.IDatamuseConstraint;
import datamuse.constraints.KindOfConstraint;
import datamuse.constraints.LeftContextHint;
import datamuse.constraints.MaximumNumberConstraint;
import datamuse.constraints.MeaningLikeConstraint;
import datamuse.constraints.MoreGeneralThanConstraint;
import datamuse.constraints.PartOfConstraint;
import datamuse.constraints.PerfectRhymeConstraint;
import datamuse.constraints.RelatedAdjectiveForNounConstraint;
import datamuse.constraints.RelatedNounForAdjectiveConstraint;
import datamuse.constraints.RightContextHint;
import datamuse.constraints.SoundsLikeConstraint;
import datamuse.constraints.SpelledLikeConstraint;
import datamuse.constraints.SynonymConstraint;
import datamuse.constraints.TopicHint;
 ...
 * .max(10);
 * 
 * Please note: In order to create clean queries and safely reuse them later,
 * every query is immutable. When calling a method that adds a constraint, it
 * will in fact create a new query.
 * 
